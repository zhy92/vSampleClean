...
} from "@/utils/formSettingsJson/search/planSetting/harvestPlan";
// table 上方按钮
import {
  operateButtons,
  materialDetailOperateButtons
} from "@/utils/formSettingsJson/operateButton/planSetting/harvestPlan";
// table表头信息设置
import {
  tableHeader,
  detailTableHeader,
  materialDetailTableHeader
} from "@/utils/formSettingsJson/table/planSetting/harvestPlan";
// 新建检测单
import {
  addButton,
  editButton,
  contentItems,
  addMaterialButton
} from "@/utils/formSettingsJson/dialog/planSetting/harvestPlan";
// 必填验证
import harvestPlanRule from "@/utils/formRulesJson/planSetting/harvestPlan";
